...
public class SysMenuController {
    ...
    public ApiResponse get(QueryCondition queryCondition){
        return ApiResponse.success(sysMenuService.listPage(queryCondition));
    }
    ...
    @PutMapping("/sysMenu")
    public ApiResponse update(@RequestBody SysMenu sysMenu) throws Exception {
        return ApiResponse.success(sysMenuService.changeById(sysMenu));
    }
