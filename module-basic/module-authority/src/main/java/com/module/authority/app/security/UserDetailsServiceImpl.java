package com.module.authority.app.security;
...
public class UserDetailsServiceImpl implements UserDetailsService, SocialUserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new PreSecurityUser(LoginType.NORMAL,user.getUserId(), username, user.getPassword(), authorities);
    }
    ...
    public UserDetails loadUserByMobile(String mobile) throws UsernameNotFoundException {
        ...
        // 获取用户拥有的角色
        Collection<? extends GrantedAuthority> authorities = getUserAuthorities(user.getUserId());
        return new PreSecurityUser(LoginType.SMS,user.getUserId(), user.getUsername(), user.getPassword(), authorities);
    }
